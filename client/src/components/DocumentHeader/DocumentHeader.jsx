...
import { getUserById } from '../Service/DocumentService'; // điều chỉnh path nếu cần
      ...
      <div className="flex flex-col md:flex-row">
        ...
        <div className="flex-1">
          ...
          <div className="flex flex-wrap gap-3 document-actions">
            ...
            <button onClick={handleFavorite} className="px-4 py-2 bg-white hover:bg-gray-50 text-gray-700 rounded-lg font-medium border border-gray-300 flex items-center">
              <i className="fas fa-heart mr-2 text-red-500" /> Yêu thích
            </button>

            <button onClick={handleShare} className="px-4 py-2 bg-white hover:bg-gray-50 text-gray-700 rounded-lg font-medium border border-gray-300 flex items-center">
              <i className="fas fa-share-alt mr-2 text-blue-500" /> Chia sẻ
            </button>

            <button onClick={handleReport} className="px-4 py-2 bg-white hover:bg-gray-50 text-gray-700 rounded-lg font-medium border border-gray-300 flex items-center">
